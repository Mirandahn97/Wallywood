...
export function MainLayout() {
    //Opret en reference til et DOM element (bindes til et element ned i HTML'en)
    ...
    useEffect(() => {
        ...
        //Fjern eventListener når vi 'un-mounter'
    ...
    return (
        <>
            ...
            <section ref={containerRef} className={style.pageContainer}>
                <ScrollBar scrollPercent={scrollPercent}></ScrollBar>
                <Navbar logoNav="WALLYWOOD" linksNav={links}></Navbar>
                <Outlet></Outlet>
                <Footer></Footer>
            </section>
        </>
